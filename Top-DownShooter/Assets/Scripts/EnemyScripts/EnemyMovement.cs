...
public class EnemyMovement : MonoBehaviour {
	...
	void ShipMovement() {
		...
		// } else 
		if(Vector2.Distance(transform.position, _playerTarget.position) < _rangeDistance && Vector2.Distance(transform.position, _playerTarget.position) > _minRangeDistance) {
